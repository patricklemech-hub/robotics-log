...
for name  in student:
    print(name, student[name], sep="->") #This command will print the key-value pairs in the dictionary. The key is the name of the item, and the value is the type of item (fruit or vegetable). For example, mango is a fruit, carrot is a vegetable, and so on
